    ...
    <Container>
        <div class="max-w-2xl">
            <h1 class="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
                Full-Stack Web Developer, Founder And Husband
            </h1>
            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                I’m Vlad, a full-stack Web developer and entrepreneur. I live with my wife
            ...
            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                Currently, I’m passionate about creating Web applications using
                Laravel + Vue + Inertia, and if you need one, let’s talk!
            </p>
            <div class="mt-6 flex gap-6">
                <a class="group -m-1 p-1" aria-label="Follow on Twitter"
                   target="_blank"
                   href="https://twitter.com/v_osmianski">
                ...
                <a class="group -m-1 p-1"
                       ...
                       target="_blank"
                       href="https://github.com/osmianski">
                    <svg viewBox="0 0 24 24" aria-hidden="true"
                         class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
